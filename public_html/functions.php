...
{ ?>
  ...
  <form action="" class="source-type">
    ...
    <div class="checkbox-script pull-right">journalists&nbsp<input type="checkbox" name="source_type" <?php
                                                                                                      if (isset($source_type) && $source_type == "journalists") {
                                                                                                        echo "checked";
                                                                                                      }
